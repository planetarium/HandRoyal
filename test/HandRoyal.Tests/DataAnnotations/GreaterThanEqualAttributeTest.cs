...
public partial class GreaterThanEqualAttributeTest
{
    ...
    {
        [GreaterThanEqual((byte)10)]
        public byte Value { get; set; }
    }

    private class SByteClass
    {
        [GreaterThanEqual((sbyte)10)]
        public sbyte Value { get; set; }
    }

    private class ShortClass
    {
        [GreaterThanEqual((short)10)]
        public short Value { get; set; }
    }

    private class UShortClass
    {
        [GreaterThanEqual((ushort)10)]
