...
internal abstract class RenderBlockEventPublisherBase<TEventData>(IServiceProvider serviceProvider)
    : IHostedService
{
    ...
    {
        _observer = _rendererService.RenderBlockEnd.Subscribe(OnRenderBlock);
    ...
    protected abstract void OnRenderBlock(RenderBlockInfo info);
}
